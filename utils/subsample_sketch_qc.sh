...
# Generate rfile
python /nfs/research/jlees/anlei/bin/utils/extract_species_subset.py "${species}" $N -o .
...
--output ${hyphened_species}_${N}_db --r-files ${hyphened_species}_${N}.rfile --sketch-size 10000 --min-k 17 --max-k 41 --plot-fit 3 --threads 48

# Find QC thresholds
printf "Looking for core and accessory distance cut-offs...\n"
eval $(python /nfs/research/jlees/anlei/bin/qc_automation/qc_automated.py "${hyphened_species}_${N}_db" "${hyphened_species}")
